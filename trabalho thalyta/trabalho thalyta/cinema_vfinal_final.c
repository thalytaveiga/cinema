...
retorna_dia_erro:
    ...
    //Go to para retornar o cÃ³digo caso haja exceÃ§Ã£o
    
    
    
    // Se o dia da semana for segunda-feira, mostrar programaÃ§Ã£o especial
    if (dia_semana==1)
    {
        system("cls");
    ...
    // Se o dia escolhido nÃ£o for segunda-feira, mostrar programaÃ§Ã£o normal
